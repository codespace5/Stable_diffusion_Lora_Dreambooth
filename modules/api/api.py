...
class Api:
    ...
    def train_model_bg(self, save_dir, train_data_dir, reg_data_dir, model_path, instance_prompt, class_prompt, max_resolution):
        ...
        session = boto3.Session(
            aws_access_key_id='AKIAQH5LSIA" ggggggggggggggggggggggggg "PXFCSO4PS',
            aws_secret_access_key='CMTs+GqAQN" gggggggggggggggggggggggg"dm7paMPGUu+mePGFSqw+arylPqCVQD',
